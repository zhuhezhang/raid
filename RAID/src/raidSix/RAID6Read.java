 ...
 * @author zhz
 */
public class RAID6Read implements Runnable{

	private ArrayList<String> diskPath;// raid6磁盘路径
	private String desFilePath;// 目标文件路径
	private String regex;// 用于查找源文件的正则表达式
	private int loc;// 当前线程的文件索引

	public RAID6Read(ArrayList<String> diskPath, String desFilePath) throws IOException {
