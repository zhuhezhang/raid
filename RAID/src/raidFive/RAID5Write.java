 ...
 * @author zhz
 */
public class RAID5Write implements Runnable {
	...
	public RAID5Write(ArrayList<String> dataDisk, ArrayList<String> parityCheckDisk, String srcFilePath)
			throws IOException {
	...
	public void writeToParityCheckDisk() throws IOException {
		...
		String toDataDiskPath = parityCkechDisk.get(0);// 将要变成数据盘的奇偶校验盘路径
