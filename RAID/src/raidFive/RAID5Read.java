 ...
 * @author zhz
 */
public class RAID5Read implements Runnable{

	private ArrayList<String> diskPath;// raid5磁盘路径
	private String desFilePath;// 目标文件路径
	private String regex;// 用于查找源文件的正则表达式
	private int loc;// 当前线程的文件索引

	public RAID5Read(ArrayList<String> diskPath, String desFilePath) throws IOException {
