 ...
 * @author zhz
 */
public class RAID3Write implements Runnable {
	...
	public RAID3Write(ArrayList<String> dataDisk, ArrayList<String> parityCkechDisk, String srcFilePath)
			throws IOException {
		this.dataDisk = dataDisk;
		this.parityCkechDisk = parityCkechDisk;
	...
	public void writeToParityCheckDisk() throws IOException {
		...
		RandomAccessFile ras = new RandomAccessFile(parityCkechDisk.get(0) + srcFileName + "-" + dflel + srcFileType,
				"rw");// 随机写方式打开
